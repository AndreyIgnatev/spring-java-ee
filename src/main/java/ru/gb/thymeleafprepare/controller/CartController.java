...
import ru.gb.thymeleafprepare.security.JpaUserDetailService;
...
public class CartController {
    ...
    @GetMapping("/gateway")
    public String cartGetway(Principal principal) {
        if (jpaUserDetailService.loadUserByUsername(principal.getName()) != null){
            return "cart-form";
        }else
